...
@RequestMapping("/cemnetus")
@Controller
@RooWebScaffold(path = "cemnetus", formBackingObject = CemnEtu.class, create = false, delete = false, update = false)
@RooWebFinder
public class CemnEtuController {
}
